package com.onpassive.admin.pdf;
...
public class GeneratePdf {
    ...
    public static ByteArrayInputStream citiesReport(List<Book> books) {
        ...
        try {
            ...
            for (Book book : books) {
                ...
                cell = new PdfPCell(new Phrase(String.valueOf(book.getAuthor())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
